            ...
            public void onResponse(Call<ResLogin> call, Response<ResLogin> response) {
                ...
                if (result != null){
                    if (result.errorCode == 0){
                        ...
                        mPrefs.setUserShopLogo(signInResModel.user.shop_logo);
                        mPrefs.setUserShopCode(signInResModel.user.shop_code);
                        mPrefs.setUserPhone(signInResModel.user.phone);
                        mPrefs.setUserAddress(signInResModel.user.address);
                        mPrefs.setUserWebsite(signInResModel.user.website);
