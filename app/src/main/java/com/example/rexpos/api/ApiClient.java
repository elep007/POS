...
//        String api_root = ((BaseActivity)context).mPrefs.getServerUrl() + "/downtime_katolec/api/v1/";
    ...
    public interface ApiInterface {
        ...
        @FormUrlEncoded
        @POST("getListTatble")
        Call<ResTable> getListTableAPI(@Field("shop_id") String shop_id);
        ...
        */
        ...
        @FormUrlEncoded
        @POST("changeOrderItem")
        Call<ResTableTransaction> changeOrderItemAPI(@Field("transaction_id") long transaction_id, @Field("table_id") long table_id, @Field("product_id") long product_id, @Field("shop_id") String shop_id,@Field("price") double price,@Field("vat_price") double vat_price);
        ...
        @FormUrlEncoded
        @POST("getReport1FromTable")
        Call<ResReport> report1API(@Field("start_date") String start_date, @Field("end_date") String end_date);

        @FormUrlEncoded
        @POST("getReport2FromTable")
        Call<ResReport> report2API(@Field("start_date") String start_date, @Field("end_date") String end_date);
    }
