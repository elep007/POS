...
public class AppPrefs {
    ...
    public final String  LOGIN_USER_SHOP_LOGO_UNDEFINED = "";
    private static String LOGIN_USER_SHOP_LOGO_DEFINED = "user_shop_logo";

    public final String  LOGIN_USER_SHOP_CODE_UNDEFINED = "";
    private static String LOGIN_USER_SHOP_CODE_DEFINED = "user_shop_code";
    ...
    public final String  LOGIN_USER_WEBSITE_UNDEFINED = "";
    private static String LOGIN_USER_WEBSITE_DEFINED = "user_website";
    ...
    public String getUserShopLogo(){return mPrefs.getString(LOGIN_USER_SHOP_LOGO_DEFINED, LOGIN_USER_SHOP_LOGO_UNDEFINED);}
    public void setUserShopLogo(String  newValue){putString(LOGIN_USER_SHOP_LOGO_DEFINED, newValue);}

    public String getUserShopCode(){return mPrefs.getString(LOGIN_USER_SHOP_CODE_DEFINED, LOGIN_USER_SHOP_CODE_UNDEFINED);}
    public void setUserShopCode(String  newValue){putString(LOGIN_USER_SHOP_CODE_DEFINED, newValue);}
    ...
    public String getUserWebsite(){return mPrefs.getString(LOGIN_USER_WEBSITE_DEFINED, LOGIN_USER_WEBSITE_UNDEFINED);}
    public void setUserWebsite(String  newValue){putString(LOGIN_USER_WEBSITE_DEFINED, newValue);}
